...
<head>
        ...
        <title>Pinegrove School - Sign In</title>
                                    ...
                                    <div class="auth-logo-dark">
                                        <div class="avatar-md profile-user-wid mb-4">
                                            <span class="avatar-title rounded-circle bg-light">
                                                <img src="{{asset('admin_assets/images/crest.png')}}" alt="" class="" height="65">
                                            </span>
                                        </div>
                                    </div>
                                </div>     
                                ...
                                <div class="p-2">
                                    ...
                                    <form  class="form-horizontal" method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="email" name="email" required autofocus  value="{{old('email')}}"  class="form-control" id="username" placeholder="Enter username">
                                        </div>
