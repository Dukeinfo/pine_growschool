                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped datatable">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>Education</td>
                                            <td>Vivek High School</td>
                                            <td>
                                                <img src="{{asset('admin_assets')}}/images/clients/vivek-school.png" alt="cleint logo" class="rounded" width="70">
                                            </td>
                                            <td>1</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>RBP Group</td>
                                            <td>
                                                <img src="{{asset('admin_assets')}}/images/clients/lawrence-mohali.png" alt="cleint logo" class="rounded" width="70">
                                            </td>
                                            <td>2</td>
                                            <td><span class="badge badge-soft-success">Active</span></td>
                                            <td>
