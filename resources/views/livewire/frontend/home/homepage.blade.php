<div  >
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <!-- About Thumb -->
                    <div class="abFact">
                        <img src="{{asset('assets/images/about.jpg')}}" alt="Pingrove">
                        <div class="abContent">
    ...
    <section class="serviceSection04" style="background-image: url({{asset('assets/images/bg/8.jpg')}});">
        <div class="container">
            <div class="row">
    ...
    <section class="aboutSection02 position-relative">
        ...
        <div class="bgsketch">
            <img src="{{asset('/assets/images/bg-sketch.png')}}" class="" alt="">
        </div>
    </section>
    
    
    <!-- BEGIN: Coaching Section Start -->
    <section class="coachingSction04" style="background-image: url({{asset('assets/images/bg/1.jpg')}});">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-6">
                    ...
                    <div class="coachingItem02 ci04 text-end">
                        <div class="coachingThumb">
                            <img src="{{asset('assets/images/f1.jpg')}}" alt="Pingrove">
                        </div>
                ...
                <div class="col-lg-4 col-sm-6">
                    ...
                    <div class="coachingItem02 ci04 text-end">
                        <div class="coachingThumb">
                            <img src="{{asset('assets/images/f2.jpg')}}" alt="Pingrove">
                        </div>
                        <div class="coachingContent text-start">
                ...
                <div class="col-lg-4 col-sm-6">
                    ...
                    <div class="coachingItem02 ci04 text-end">
                        <div class="coachingThumb">
                            <img src="{{asset('assets/images/f3.jpg')}}" alt="Pingrove">
                        </div>
                        <div class="coachingContent text-start">
                            <h3><a href="javascript:void()">Games & Sports</a></h3>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="owl-carousel owl-theme">
                        ...
                        <!-- <div class="item">
                            <a href="#"><img src="{{asset('assets/images/partners/p-1.png')}}" class="border" alt=""></a>
                        </div>
                        <div class="item">
                            <a href="#"><img src="{{asset('assets/images/partners/p-2.png')}}" class="border" alt=""></a>
                        </div>
                        <div class="item">
                            <a href="#"><img src="{{asset('assets/images/partners/p-3.png')}}" class="border" alt=""></a>
                        </div>
                        <div class="item">
                            <a href="#"><img src="{{asset('assets/images/partners/p-4.png')}}" class="border" alt=""></a>
                        </div>
                        <div class="item">
                            <a href="#"><img src="{{asset('assets/images/partners/p-5.png')}}" class="border" alt=""></a>
                        </div>
                        <div class="item">
                            <a href="#"><img src="{{asset('assets/images/partners/p-6.png')}}" class="border" alt=""></a>
                        </div>
                        <div class="item">
                            <a href="#"><img src="{{asset('assets/images/partners/p-7.png')}}" class="border" alt=""></a>
                        </div>
                        <div class="item">
                            <a href="#"><img src="{{asset('assets/images/partners/p-8.png')}}" class="border" alt=""></a>
                        </div>
                        <div class="item">
                            <a href="#"><img src="{{asset('assets/images/partners/p-9.gif')}}" class="border" alt=""></a>
                        </div>
                        <div class="item">
                            <a href="#"><img src="{{asset('assets/images/partners/p-10.png')}}" class="border" alt=""></a>
                        </div>
                        <div class="item">
                            <a href="#"><img src="{{asset('assets/images/partners/p-11.png')}}" class="border" alt=""></a>
                        </div> -->
                    </div>
                </div>
            </div>
    ...
    <section class="CTASection02" style="background-image: url({{asset('assets/images/bg/bg1.jpg')}});">
        <div class="container">
            <div class="row">
                    ...
                    <div class="countrySlider owl-carousel">
                        ...
                        <div class="countryItem02 text-center">
                            <div class="countryThumb">
                                <img src="{{asset('assets/images/facilities/fac1.jpg')}}" alt="Pingrove">
                            </div>
                        ...
                        <div class="countryItem02 text-center">
                            <div class="countryThumb">
                                <img src="{{asset('assets/images/facilities/fac2.jpg')}}" alt="Pingrove">
                            </div>
                            <div class="countryContent">
                        ...
                        <div class="countryItem02 text-center">
                            <div class="countryThumb">
                                <img src="{{asset('assets/images/facilities/fac3.jpg')}}" alt="Pingrove">
                            </div>
                            <div class="countryContent">
                        ...
                        <div class="countryItem02 text-center">
                            <div class="countryThumb">
                                <img src="{{asset('assets/images/facilities/fac4.jpg')}}" alt="Pingrove">
                            </div>
                            <div class="countryContent">
                        ...
                        <div class="countryItem02 text-center">
                            <div class="countryThumb">
                                <img src="{{asset('assets/images/facilities/fac5.jpg')}}" alt="Pingrove">
                            </div>
                            <div class="countryContent">
    ...
    <section class="testimonialSection01" style="background-image: url({{asset('assets/images/bg/bg1.jpg')}});">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
    ...
    <section class="blogSction02">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-sm-6">
                    <!-- Blog Item -->
                     @php $timestamp = strtotime($boardmember->dated); @endphp
                    <div class="blogItem02 text-end">
                        <div class="blogThumb">
                            <img src="{{asset('assets/images/blog/1.jpg')}}" alt="Pingrove">
                            <div class="pDate"><span>{{ $month = date('d', $timestamp) }}</span> {{ $month = date('M', $timestamp) }}</div>
                        </div>
                        <div class="blogContent text-start">
                            ...
                            <h3><a href="javascript:void();">{{$boardmember->heading ?? 'N/A' }}</a></h3>
                            {!!$boardmember->description ?? 'N/A' !!}
                        </div>
