                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row g-3">
                                ...
                                <div >
                                    <button wire:loading.attr="disabled" type="submit" wire:click="editSubCategory" class="btn btn-primary w-md">Submit</button>
                                </div>
                                 <div wire:loading wire:target="editSubCategory">
