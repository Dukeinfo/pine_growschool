                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row g-3">
                               ...
                               <div>
                                <button type="submit" wire:loading.attr="disabled"  class="btn btn-primary w-md" wire:click="virtualTour">Submit</button>
                               
                            </div>
                            <div wire:loading wire:target="virtualTour">
                                    ...
                                    <tbody>
                                      @if(isset($records) && count($records)>0 )                      
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('edit_virtual_tour',['id' => $record->id])}}" class="text-success me-2" title="Edit"><i class="fa fa-edit fa-fw"></i></a>
