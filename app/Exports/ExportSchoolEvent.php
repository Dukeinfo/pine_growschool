...
class ExportSchoolEvent implements FromCollection, WithHeadings , ShouldAutoSize, WithStyles
{
    /**
    ...
    */
    ...
    {
        return SchoolCalendar::select($this->selectedFields)->get(); // Replace 'Example' with your model
    }
